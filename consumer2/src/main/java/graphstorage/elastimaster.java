...
public class elastimaster {
    ...
    public elastimaster(RestHighLevelClient client) {
        this.client = client;
    }
	...
	public void deleteMessage(String value) throws IOException {
		// TODO Auto-generated method stub
		

        JSONObject jsonBody = new JSONObject(value);
